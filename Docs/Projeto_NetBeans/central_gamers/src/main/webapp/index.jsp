	...
	<body align="center">
		...
		<header>
			...
			<div align="center">
				...
				<div class="BarraSuperior">
					...
					<input type="button" Onclick="window.location.reload()" class="BotoesSuperiores" value="Fórum" >
			...
			<div class="BarraInferior">
				...
				<div class="ListaJogos">
					...
					<ul class="MenuInferior">
						...
						<li><a href="#">Gênero</a>
							<ul>
					                <li class="FundoDrop"><a href="#">Ação</a></li>
					                <li class="FundoDrop"><a href="#">Aventura</a></li>
					                <li class="FundoDrop"><a href="#">Estratégia</a></li> 
						...
						<li><a href="#">Pre-Lançamentos</a></li>
		...
		<section>
			...
			<div class="Secções">
				...
				<div class="TopicosFundo">
					<h1 class="Topicos"> Lançamentos </h1> 
				</div>
		...
		<footer>
			...
			<div align="center">
				...
				<p class="Rodapetext"> Seja bem vindo(a) ao Central Gamers! O nosso objetivo é tornar as informações e jogos cada vez mais acessiveis ao ditos Gamers! O nosso diferencial é trazer junto a jogos aquilo que da a sua origem, ou seja, a sua criação. Criamos uma parte dentro do nosso site especialmente para intuasiastas e desenvolvedores de jogos, dos iniciantes aos mais experientes. Faça do nosso site a sua caverna gamer, faça amigos, socialize, aprenda e, por fim, divirta-se! </p> 
